  ...
  Future<void> _reply() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        CommonFunctions.showSuccessToast('تم نشر الرد');
        activeQuestions.clear();
      }
    } catch (error) {
      // print(error);
      const errorMsg = 'لا يمكن الرد';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['status'] != 200) {
          throw const HttpException('تعذرت الإزالة.');
        } else {
          setState(() {
            activeQuestions.removeAt(index);
          });
          CommonFunctions.showSuccessToast('تم حذف الرد');
