                      ...
                      child: Column(
                        children: [
                          ...
                          const Padding(
                            padding: EdgeInsets.all(4.0),
                            child:
                                Text('الرجاء التحقق من اتصال الانترنت الخاص بك'),
                          ),
                          Padding(
                            ...
                            child: ElevatedButton.icon(
                              ...
                              label: const Text(
                                'تشغيل الدورات دون اتصال بالإنترنت',
                        ...
                        SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              ...
                              child: GestureDetector(
                                child: const AccountListTile(
                                  titleText: 'الدورس التي تم تنزيلها',
