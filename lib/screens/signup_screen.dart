  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (user.emailVerification == 'enable') {
        if (user.message ==
            "لقد قمت بالتسجيل بالفعل. يرجى التحقق من البريد الوارد الخاص بك للتحقق من عنوان البريد الإلكتروني الخاص بك") {
        ...
        CommonFunctions.showSuccessToast('الاشتراك بنجاح');
      }
    } catch (error) {
      const errorMsg = 'لا يمكن التسجيل!';
      // print(error);
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            validator: (value) {
                              if (value!.isEmpty) {
                                return 'لا يمكن أن يكون الاسم الأخير فارغًا';
                              }
                              return null;
                            },
                            onSaved: (value) {
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            validator: (input) => input!.length < 3
                                ? "يجب أن تكون كلمة المرور أكثر من 3 أحرف"
                                : null,
